class Employee:
    ...
    def __init__(self, firstname: str, lastname: str, pay: str | float=200_000):
    ...
    @classmethod
    def set_org_domain(cls, new_domain: float) -> None:
        cls.org_domain = new_domain

    @classmethod
    def set_raise_amount(cls, new_amount: float) -> None:
...
class Developer(Employee):
    ...
    def __init__(self, firstname: str, lastname: str, pay: str | float=200_000, prog_lang: str ='Python'):
