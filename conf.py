...
copyright = 'Cédric Donner, Collège du Sud, 2025'
...
html_title = 'WebTigerPython : un IDE complet dans le Web'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'WebTigerPython'
