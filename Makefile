...
RSYNC_OPTIONS= $(RSYNC_BASE_OPTIONS) --exclude=.git --exclude=.venv --exclude=programs --exclude=venv --exclude=ubuntu --exclude=stats --exclude=__pycache__ --exclude=junk --exclude=errors
